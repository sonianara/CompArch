...
#include "mips_asm_header.h"	/* Define the mips_asm binary header */
...
MIPS mem[] = { 0x0C10000C, 0x3402000A, 0x0000000C, 0x02114026, 0x31050002, 0x1088FFFE, 0x08100010, 0x03E00008 };
